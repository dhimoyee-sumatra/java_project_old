...
public class UnrestrictedGuessingGame extends JPanel implements ActionListener {
		...
		noButton.addActionListener( new ActionListener() {
			public void actionPerformed( ActionEvent e )
			{
				 ...
				 */
					if(gameNode.getRightChild()==null)
					{
						String answer= JOptionPane.showInputDialog("Can you insert the character's name you were thinking?") ;
						String question= JOptionPane.showInputDialog("Please give me a yes/no question that would have determined your thing") ;
						String option= JOptionPane.showInputDialog("Is the answer to your question yes or no?") ;
						JOptionPane.showMessageDialog(null,"Your input has been saved. Thank you! :)", "Message", JOptionPane.INFORMATION_MESSAGE);
						String replacer= gameNode.getData();
						gameNode.setData(question);
						BinaryTreeNode<String> leftChild= new DefaultBinaryTreeNode<String>();
						BinaryTreeNode<String> RightChild= new DefaultBinaryTreeNode<String>();
						
						/**
						 * resets the binary tree depending on the inputs
						 * replace the data in the node with the question
						 * sets the answer and option as children for the node 
						...
						if(!option.equals(null))
						{
							...
							{
								leftChild.setData(answer);
								RightChild.setData(replacer);
							}
							else
							{
								leftChild.setData(replacer);
								RightChild.setData(answer);
							}
							
							gameNode.setLeftChild(leftChild);
							gameNode.setRightChild(RightChild);
						}
	...
	public static void main(String[] args) {
		...
		guiFrame.add( new UnrestrictedGuessingGame() );
